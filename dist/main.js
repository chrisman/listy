...
var $author$project$Main$init = $author$project$Main$emptyModel;
...
var $author$project$Main$newEntry = F2(
	function (desc, id) {
		return {completed: false, description: desc, id: id};
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('deleteTodo'),
						$elm$html$Html$Events$onClick(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Listy list')
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$placeholder('add an item'),
